  ...
  <div class="seller" ref="seller">
    <div class="seller-content">
      ...
      <div class="bulletin">
        ...
        <div class="content-wapper border-1px">
      ...
      <div class="pics">
        ...
        <div class="pic-wrapper" ref="picWapper">
...
<script type="text/ecmascript-6">
  ...
  export default {
    data() {
      return {
        favorite: (() => {
          return loadFromLocal(this.seller.id, 'favovite', false);
        })()
      };
    },
    props: {
    ...
    methods: {
      toggleFavorite(event) {
        ...
        saveToLocal(this.seller.id, 'favovite', this.favorite);
      },
      _initScroll() {
        if (!this.scroll) {
